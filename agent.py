...
**第1轮：定位2-3个候选展会**
- 搜索词：`[行业关键词] trade show [目标市场] 2025 2026 exhibitor registration`
- 搜索词：`[产品类别] expo [目标市场] 2025 official site`
- 目标：找到2-3个行业最相关的展会名称、主办方、大概时间

**第2轮：核实每个候选展会的关键信息**
- 针对每个候选展会搜索：日期、地点、展位费、展商规模、主办方官网
- 搜索格式：`"[展会名称]" 2025 2026 booth fee exhibitor official`
- 如发现主办方社交媒体有更新动态，一并记录来源
